...
class TradingAgent:
    ...
    def _decide(self, context, assets):
        ...
        system_prompt = (
            ...
            "  • IMPORTANT: Consider fees (~0.08% round trip). Taking 10-15% profit and re-entering is often better than holding for 40%+\n"
            "  • BUY: tp_price > current_price. Set REALISTIC targets: 8-15% for most trades, max 20% for strong trends\n"
