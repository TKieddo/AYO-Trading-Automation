//@version=6
strategy("Scalping PullBack Tool R1.1 by JustUncleL", shorttitle="SCALPTOOL R1.1", overlay=true, initial_capital=10000, default_qty_type=strategy.percent_of_equity, default_qty_value=10, commission_type=strategy.commission.percent, commission_value=0.1)
...
// Exit long position when trend reverses
if strategy.position_size > 0 and haClose < pacC
    strategy.close("Long", comment="Exit Long")

// Exit short position when trend reverses
if strategy.position_size < 0 and haClose > pacC
