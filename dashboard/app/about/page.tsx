  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl ring-1 ring-slate-200 bg-white p-6">
        ...
        <p className="text-slate-600">AYO is an AI trading agent that connects to the Hyperliquid decentralized exchange to analyze markets, generate insights, and execute rules-based strategies without emotion. Our mission is to bring disciplined, transparent, and automatable trading tooling to crypto-native participants.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="rounded-2xl ring-1 ring-slate-200 bg-white p-5">
          ...
          <ul className="list-disc pl-5 space-y-1 text-slate-600">
            ...
            <li>Executes on Hyperliquid with your limits</li>
        ...
        <div className="rounded-2xl ring-1 ring-slate-200 bg-white p-5">
          ...
          <p className="text-slate-600">AYO ingests data, evaluates conditions against strategy rules, and—subject to your approvals—submits orders via Hyperliquid. Safety features include position sizing, max-loss constraints, and stop logic. You retain full control: run in simulation, enable/disable, and tune parameters.</p>
        </div>
        <div className="rounded-2xl ring-1 ring-slate-200 bg-white p-5">
