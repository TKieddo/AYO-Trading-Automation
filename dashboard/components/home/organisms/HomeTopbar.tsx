  ...
  return (
    <header className="h-16 bg-black border-b border-gray-800 flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <Link href="/dashboard" className="px-4 py-1.5 border border-white rounded-full text-white text-sm flex items-center gap-2 hover:bg-gray-900 transition-colors">
